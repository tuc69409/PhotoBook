...
public class API {
	...
	static final String APIBaseURL = " http://cis-linux2.temple.edu/~tuf77221/index/";
    /**
    ...
    private static String extractHttpResponse(HttpResponse httpResponse) throws IllegalStateException, IOException{
	 ...
	 public static JSONArray photoBooktoJson(Context context, int userId) throws Exception{
	    	
	     /*Make sure matches php name*/  
		 String response = makeAPICall(context,  RequestMethod.GET, "photobook.php", null);
